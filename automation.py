...
class Automation(unittest.TestCase):
    ...
    def test_music(self): #Acciones para automatizar
        driver = self.driver
        ...
        articule_search = driver.find_element_by_xpath('//*[@id="rso"]/div[4]/div/div/div[2]/div[1]').text
        articule_link = driver.find_element_by_xpath('//*[@id="rso"]/div[3]/div/div/div[1]/a/div').text
...
if __name__ == '__main__':    
    unittest.main(verbosity=2, testRunner= HTMLTestRunner(output= 'report', report_name = 'automation-report'))
